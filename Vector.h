...
namespace neo
{
    ...
    public:
        ...
        constexpr Vector() : m_capacity(DEFAULT_SIZE)
        {
        ...
        constexpr Vector(const Vector& other) : m_size(other.m_size), m_capacity(other.m_capacity)
        {
        ...
        constexpr Vector(Vector&& other) : m_capacity(other.m_capacity), m_size(other.m_size)
        {
            m_data = other.m_data;
            other.m_capacity = 0;
            other.m_size = 0;
        ...
        explicit constexpr Vector(const Span<T>& other) : m_capacity(other.size()), m_size(other.size())
        {
            VERIFY(other.size() > 0);
            m_data = new T[m_size];
